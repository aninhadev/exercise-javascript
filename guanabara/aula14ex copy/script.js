// function calcular() {
//   let valorInicio = document.getElementById("valinicio").value;
//   let valorFim = document.getElementById("valfim").value;
//   let valorPasso = document.getElementById("valpasse").value;

// //   alert("Vai começar");
//   for (c = valorInicio; c <= valorFim; c += valorPasso) {
//     console.log(`${c} `);
//   }
// //   alert("FIM");
// }
